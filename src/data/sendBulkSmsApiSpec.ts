  ...
  tags: [
    {
      ...
      description:
        "از این متد برای ارسال پیامک به‌صورت گروهی به چندین گیرنده استفاده می‌شود. در این روش، شماره فرستنده و متن پیام تنها یک‌بار مشخص می‌شود و پیام به‌صورت هم‌زمان برای تمامی گیرندگان ارسال می‌گردد؛ بنابراین نیازی به تعریف جداگانه‌ی شماره فرستنده یا متن پیام برای هر گیرنده نیست.",
    },
  ],
  paths: {
